...
<div class="col-sm-12">
    <div class="card">
        <div class="card-header py-2">
            <div class="row justify-content-between">
                <div class="col-sm-6 d-flex align-items-center">
                    <h2 class="my-0">Create Location</h2>
                </div>
        ...
        <!-- table input data -->
        <div class="card-body">
            <form action="<?= base_url('data-master/location/create') ?>" method="post" id="locationCreate">
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="kode_zip" id="kode_zip" class="form-control" required>
                        </div>
                    </div>
                </div><br>
...
<script>
    $(function($) {
        ...
        $('#locationCreate').submit(function(e) {
            e.preventDefault();
