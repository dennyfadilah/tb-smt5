    ...
    <div class="card dashnum-card dashnum-card-small overflow-hidden">
        ...
        <div class="card-header py-3">
            <div class="d-flex align-items-center">
                <h2 class="my-0">Create Transaction Page</h2>
            </div>
        </div>
            ...
            <div class="ms-2">
                <form action="<?= base_url('transaksi/create') ?>" method="post" id="transaksiCreate">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="marketing_nama" name="marketing_nama" value="<?= session()->get('nama') ?>" readonly>
                    </div>

                    <div class="form-group mb-3">
                        <label for="waktu" class="form-label">Date Time Survey</label>
                        <input type="date" class="form-control" id="waktu" name="waktu" value="<?= date('Y-m-d') ?>" readonly>
                    </div>
