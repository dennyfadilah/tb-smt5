...
function layout_change(layout) {
	...
	if (layout == "dark") {
		...
		if (document.querySelector(".navbar-brand .brand-logo")) {
			document
				.querySelector(".navbar-brand .brand-logo")
				.setAttribute("src", "../assets/images/logo-white.svg");
		}
		if (document.querySelector(".auth-main .brand-logo")) {
			document
				.querySelector(".auth-main .brand-logo")
				.setAttribute("src", "../assets/images/logo-white.svg");
		}
...
document.addEventListener("DOMContentLoaded", (event) => {
	const topLink = document.querySelector(".pc-head-link[href='#']");

	// Menambahkan event listener untuk menangkap klik pada elemen tersebut
	topLink.addEventListener("click", function (event) {
		event.preventDefault(); // Mencegah tindakan default (navigasi ke #)
		// Lakukan aksi lain yang diinginkan saat link diklik
	});

	// Menangkap semua elemen dengan kelas 'pc-link' yang memiliki href '#'
	const links = document.querySelectorAll('.pc-link[href="#"]');
